 ...
 */
package com.collegesoftware.cyclopes.camera;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public void add(T graphic) {
        synchronized (lock) {
            countForAdd++;
            Log.d("graplay","graphic added "+countForAdd);
    ...
    public T getGraphicAtLocation(float rawX, float rawY) {
        Log.d("textforcam","getGraphLocation()");
        synchronized (lock) {
            Log.d("textforcam","in lock");
            ...
            for (T graphic : graphics) {
                if (graphic.contains(rawX - location[0], rawY - location[1])) {
                    Log.d("textforcam","graph has text");
                    Log.d("textforcam","text is ");
                    return graphic;
                }
            }
            return null;
